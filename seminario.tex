 ...
 \section{Programação Reflexiva}
	 ...
	 \end{frame}	  	 
 	 ...
 	 \begin{frame}{Intercessão Comportamental}
 	 	...
 	 	\begin{block}{Suporte}
 	 		\begin{description}[Smalltalk]
 	 			\item [Smalltalk] Limitado; \alert{Melhorar}
 	 			\item [Java] Inexistente;
 	 			\item [Scala] Suportado via \emph{mirrors};
 	 		\end{description}
 	 	\end{block}
 	 	\begin{block}{\emph{Mirror} -- Definição}
 	 		\alert{Escrever}
 	 	\end{block}
 	 \end{frame}
 	 \begin{frame}{Intercessão Comportamental -- Exemplos (Scala)}
 	 	\alert{escrever}
 	 \end{frame}
