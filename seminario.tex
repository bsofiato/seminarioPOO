...
\belowdisplayshortskip=0pt	
 ...
 \section{Meta-modelo}
	 ...
	 \begin{frame}{MOF -- Meta-object Facility}
	 	...
	 	\end{block}	 
	 	\begin{block}{ }
 	 		\centerline{\includegraphics[trim=0 370 250 0, clip=true, totalheight=0.80\textheight]{mof.pdf}}
	 	\end{block}
     \end{frame}
	 \begin{frame}{Meta-modelo UML}
	 	...
	 	\end{block}
	 	\begin{block}{ }
 	 		\centerline{\includegraphics[trim=0 400 70 0, clip=true, height=0.80\textheight]{uml.pdf}}
	 	\end{block}
	\end{frame}	 	
	% \begin{frame}[c]{ }
	%	\centering
